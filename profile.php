...
<body>
   <p>Bonjour voici votre profil : </p>
<?php
   session_start();
   require "./connect.php";
...
$calendar->add_event('Vacances', '2022-06-30', 7);
    /////////// AFFICHAGE //////////////////////////////////
    $sql_data = $db->prepare('SELECT nom,prenom,âge,taille FROM data where login=?');
    $sql_data->execute([$login]);
    $results_data = $sql_data->fetchAll();
